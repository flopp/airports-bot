...
setuptools.setup(
    name="airports-bot",
    version=_read_version("airports_bot/version.py"),
    description='A twitter bot that tweets satellite images of random airports',
    ...
    entry_points={"console_scripts": ["airports-bot = airports_bot.cli:main",],},
